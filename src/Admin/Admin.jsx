...
const Admin = ({ isSidebarOpen, isSidebarCollapsed }) => {
  ...
  useEffect(() => {
    ...
    const fetchAgentPerformance = async () => {
      try {
        const response = await fetch("https://mersols.com/get-all-agents-performance");
        const data = await response.json();
        if (data.success) {
  ...
  const fetchStudentNames = async () => {
    ...
    try {
      const response = await fetch("https://mersols.com/get-student-names");
  ...
  const fetchAgentDetail = async (agentName) => {
    ...
    try {
      const response = await fetch(`https://mersols.com/get-agent-performance/${agentName}`);
      const result = await response.json();
